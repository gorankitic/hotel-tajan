        ...
        <div className="grid grid-cols-5 gap-x-24 gap-y-24 text-xl items-center">
            <div className="col-span-3">
                ...
                <div className="space-y-8">
                    ...
                    <p>
                        Наших 10 удобних апартмана су само почетак, прави мир и слободу ћете пронаћи у шетњи кроз планинске шуме или посматрајући како звезде трепере удобно смјештени покрај камина.
                    </p>
                    <p>
